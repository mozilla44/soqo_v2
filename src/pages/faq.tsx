        ...
        >
          <Item label="Est-ce que Soqo* est une association ?">
            <Text {...titleProps}>
              ...
              à mission de l&apos;Économie Sociale et Solidaire (ESS) sous
              statut juridique SAS. Contrairement aux associations, nous ne
              sommes pas éligibles aux dispositifs de défiscalisation pour les
              dons (qui sont possibles pour les associations), mais nous
              poursuivons une mission sociale et environnementale aussi
              ambitieuse.
            </Text>
          </Item>
          <Item label="Qu'est-ce qu'une société à mission ?">
            <Text {...titleProps}>
              ...
              objectifs financiers, s&apos;engage dans des actions concrètes
              pour des objectifs sociaux et environnementaux, intégrés dans ses
              statuts. Chez Soqo*, nous avons formalisé cet engagement pour
              maximiser notre impact positif dans la société.
            </Text>
          </Item>
          ...
          <Item label="Comment Soqo* choisit ses partenaires ?">
            <Text {...titleProps}>
              ...
              pour des valeurs communes, de leur potentiel d&apos;impact et de
              leur volonté de s&apos;engager durablement pour le changement.
              Nous recherchons des partenaires motivés, prêts à collaborer pour
              atteindre des objectifs concrets et positifs.
            </Text>
          </Item>
          <Item label="Soqo* accompagne-t-il uniquement de grandes entreprises ?">
            <Text {...titleProps}>
              Soqo* accompagne aussi bien les grandes entreprises que les PME et
              TPE. Notre objectif est de permettre à toute entreprise désireuse
              de s&apos;engager dans une démarche de responsabilité sociale de
              bénéficier d&apos;un accompagnement adapté, quels que soient sa
              taille et son secteur.
            </Text>
          </Item>
          <Item label="Est-ce que Soqo* est une agence événementielle ?">
            <Text {...titleProps}>
              Soqo* n&#39;est pas une agence événementielle (ni une agence de
              communication). Nous ne produisons pas d&apos;événements, mais
              nous accompagnons les entreprises et leurs agences pour rendre
              leurs événements plus responsables, en intégrant des pratiques
          ...
          <Item label="Comment Soqo* évalue l'efficacité de ses actions ?">
            <Text {...titleProps}>
              ...
              retours d&apos;expérience de nos partenaires et bénéficiaires.
              Dans la mesure du possible, nous menons aussi des analyses
              d&apos;impact en collaboration avec notre partenaire Impact Track
              pour offrir des résultats plus précis et quantifiables.
            </Text>
          </Item>
          ...
          <Item label="Les projets de Soqo* se déroulent-ils uniquement en France ?">
            <Text {...titleProps}>
              Soqo* est une société française, et la majorité de nos projets se
              déroulent sur le territoire national. Cependant, nous accompagnons
              également les entreprises dans leurs projets à
              l&apos;international. Grâce à un réseau de partenaires développé
              au fil des années, nous pouvons intervenir dans toutes les régions
              du monde.
            </Text>
          </Item>
        </VStack>
